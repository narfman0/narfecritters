...
from narfecritters.game.move_damage import move_damage
...
class TestMoveDamage(unittest.TestCase):
    def test_move_damage(self):
        ...
        self.assertEqual(4, move_damage(critter1, critter2, scratch, random).damage)
        ember = Move(id=2, name="ember", power=35, type_id=10)
        self.assertEqual(14, move_damage(critter1, critter2, ember, random).damage)
